...
namespace ep24.web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            var histories = orderRepo.List(it => it.PaidDate.HasValue).ToList();
            return histories;
        }
        ...
        {
            if (request == null || request.OrderedProducts == null) return new OrderProductResponse { Message = "ไม่พบเมนูที่จะสั่ง" };
